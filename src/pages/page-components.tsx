  ...
  return (
    <Container className="flex flex-col gap-2 items-center justify-center my-20">
      ...
      <div className=" flex flex-wrap gap-2 justify-center">
        ...
        <Button handling variant="primary">
          <Crown size={24} />
          button
        </Button>
        <Button handling variant="secondary">
          <Crown size={24} />
          button
        </Button>
        <Button handling variant="ghost">
          <Crown size={24} />
          button
        </Button>
      </div>
      <div className=" flex gap-2">
        ...
        <IconButton handling icon={<Crown size={24} />} />
        <IconButton handling variant="secondary" icon={<Crown size={24} />} />
        <IconButton handling variant="ghost" icon={<Crown size={24} />} />
      </div>
      <div className=" flex gap-2">
        <InputText />
      </div>
